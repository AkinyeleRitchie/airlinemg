...
import sqlite3
import subprocess  # To run the admin.py or flight.py file after successful login
    ...
    def login():
        ...
        if result:
            ...
            if position.lower() == "admin":
                open_admin_page()  # Open the admin.py page
            elif position.lower() == "flight attendant":
                open_flight_attendant_page()  # Open the flight.py page
            else:
...
def open_admin_page():
    ...
    subprocess.Popen(["python", "admin.py"])  # On Windows, you may need to use "python" or "python3"

# Function to open flight.py page
def open_flight_attendant_page():
    # This will open flight.py as a separate process.
    subprocess.Popen(["python", "flight.py"])  # On Windows, you may need to use "python" or "python3"
